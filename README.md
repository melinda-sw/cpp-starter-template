# cpp-starter-template [![Build Status](https://circleci.com/gh/melinda-sw/cpp-starter-template.svg?style=shield)](https://app.circleci.com/pipelines/github/melinda-sw/cpp-starter-template)
