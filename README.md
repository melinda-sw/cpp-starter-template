# cpp-starter-template [![GitHub Build status](https://github.com/melinda-sw/cpp-starter-template/workflows/GitHub%20CI/badge.svg)](https://github.com/melinda-sw/cpp-starter-template/actions?query=workflow%3A%22GitHub+CI%22)
